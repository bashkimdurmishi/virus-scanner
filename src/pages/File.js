  ...
  const renderLoading = () => {
    return (
      <TableRow key={"no-data"}>
        <TableCell component="td" colSpan={3} scope="row">
          Loading results...
        </TableCell>
      </TableRow>
    );
  ...
  const renderAnalysing = () => {
    return (
      <TableRow key={"analysing-data"}>
        <TableCell component="td" colSpan={3} scope="row">
          Analysing file... File is in queue, please wait and press the refresh
